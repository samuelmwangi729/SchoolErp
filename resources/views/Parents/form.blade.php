...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control input-sm" name="Names" placeholder="Enter Parent Names">
        </div>
    </div>
    <!--end col-->
     <!--start col-->
     <div class="col-sm-4">
        <div class="form-group">
            ...
            <input type="email" class="form-control input-sm" name="Email" placeholder=" Empty if No Address">
        </div>
    </div>
    <!--end col-->
     <!--start col-->
    ...
    <!--end col-->
     ...
     <div class="col-sm-4">
        <div class="form-group">
            ...
            <input class="form-control input-sm" type="number" name="PhoneNumber">
        </div>
    </div>
    <!--end col-->
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control input" name="Nationality" placeholder="Eg. Kenyan">
        </div>
    </div>
    <!--end col-->
     <!--start col-->
